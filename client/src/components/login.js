				...
				<div className="loginForm">
					...
					<div className="loginFormContainer">
						<form>
							...
							/>{' '}
							<br />
							<select name="user" className="form-control loginInput" onChange={this.handleChange}>
								<option> Select type of user </option> <option value="employer"> Employer </option>{' '}
							...
							<button className="continueButton" onClick={this.handleSubmit}>
								Continue{' '}
							</button>{' '}
						</form>{' '}
					</div>{' '}
